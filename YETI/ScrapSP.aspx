<%@ Page Title="" Language="C#" MasterPageFile="~/Yeti.Master" AutoEventWireup="true" CodeBehind="ScrapSP.aspx.cs" Inherits="YETI.ScrapSP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <br />Pedimento:<br />
            <asp:TextBox ID="txtPedimento" runat="server" CssClass="form-control-sm"></asp:TextBox>
        </div>
             <div class="col-sm-2">
            <br />SKU #:<br />
