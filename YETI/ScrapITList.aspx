<%@ Page Title="" Language="C#" MasterPageFile="~/Yeti.Master" AutoEventWireup="true" CodeBehind="ScrapITList.aspx.cs" Inherits="YETI.ScrapITList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager ID="Sd" runat="server"></asp:ScriptManager>
     <div class="row"> 
        <div class="col-sm-12">  
            <h2>Scrap IMMEX Transfer List</h2>  
            </div>
         </div>
      <div class="row">
                ...
                <MasterTableView>
                    <Columns> 
                        <telerik:GridTemplateColumn HeaderText="Date">
                         ...
                         <telerik:GridTemplateColumn HeaderText="IMMEX Name">
                            <ItemTemplate><%#Eval("fs_immexNombre") %></ItemTemplate>
                        </telerik:GridTemplateColumn>
