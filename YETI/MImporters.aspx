<%@ Page Title="Importers" Language="C#" MasterPageFile="~/Yeti.Master" AutoEventWireup="true" CodeBehind="MImporters.aspx.cs" Inherits="YETI.MImporters" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-sm-12"><h3>Imports</h3></div>
    </div>
    <div class="row">
         <div class="col-sm-12">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="addModal-label">Add Importer</h4>
