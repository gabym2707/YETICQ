...
namespace YETI
{
    ...
    public partial class SouthBound
    {
        ...
        public DateTime fd_shipDate { get; set; }
        public int fi_exportRecords { get; set; }
        public string fs_exportRecords { get; set; }
        public int fi_importRecords { get; set; }
        ...
        public double fd_totalWeightLbs { get; set; }
        public decimal fd_unitPrice { get; set; }
